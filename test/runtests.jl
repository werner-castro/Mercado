...
# !!! Main.UserApp is configured as an alias for Main.Mercado and you might encounter it in some tests
using Main.Mercado, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Mercado tests" begin
  @includetests ARGS
end
